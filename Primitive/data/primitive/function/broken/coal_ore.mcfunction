execute at @s run setblock ~ ~ ~ minecraft:coal_ore
execute at @s run summon item ~ ~ ~ {Item:{id:coal,count:1,components:{custom_data:{burn_time:1000}}}}
execute at @s run summon item ~ ~ ~ {Item:{id:gray_dye,count:1,components:{custom_data:{gravel:1},custom_name:{"text":"Gravel","italic":false}}}}
