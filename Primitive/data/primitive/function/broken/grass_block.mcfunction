...
execute at @s run summon item ~ ~ ~ {Item:{id:brown_dye,count:1,components:{item_model:"primitive_pack:dirt_piece",custom_data:{dirt:1},custom_name:{"text":"Dirt","italic":false}}}}
execute at @s run summon item ~ ~ ~ {Item:{id:green_dye,count:1,components:{item_model:"primitive_pack:grass_piece",custom_data:{grass:1},custom_name:{"text":"Grass","italic":false}}}}
