execute at @s run setblock ~ ~ ~ minecraft:sand
execute at @s run summon item ~ ~ ~ {Item:{id:yellow_dye,count:1,components:{item_model:"primitive_pack:sand_piece",custom_data:{sand:1},custom_name:{"text":"Sand","italic":false}}}}
