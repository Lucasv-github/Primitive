...
execute if entity @e[limit=1,sort=nearest,type=minecraft:armor_stand,tag=fired_pot,distance=..1,tag=boiled_water] run scoreboard players set Temp reg_1 1
execute if entity @e[limit=1,sort=nearest,type=minecraft:armor_stand,tag=fired_pot,distance=..1,tag=raw_water] run scoreboard players set Temp reg_1 2
execute if entity @e[limit=1,sort=nearest,type=minecraft:armor_stand,tag=fired_pot,distance=..1,tag=salt_water] run scoreboard players set Temp reg_1 3
...
execute if score Temp reg_1 matches 1 run data modify entity @e[limit=1,sort=nearest,type=minecraft:item,tag=pot_broken] Item.components.minecraft:custom_data merge value {boiled_water:1}
execute if score Temp reg_1 matches 2 run data modify entity @e[limit=1,sort=nearest,type=minecraft:item,tag=pot_broken] Item.components.minecraft:custom_data merge value {raw_water:1}
execute if score Temp reg_1 matches 3 run data modify entity @e[limit=1,sort=nearest,type=minecraft:item,tag=pot_broken] Item.components.minecraft:custom_data merge value {salt_water:1}
