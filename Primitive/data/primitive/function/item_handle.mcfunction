...
#Stripped logs
execute as @s[nbt={Item:{id:"minecraft:stripped_oak_log"}}] run function primitive:broken/stripped_log
execute as @s[nbt={Item:{id:"minecraft:stripped_spruce_log"}}] run function primitive:broken/stripped_log
execute as @s[nbt={Item:{id:"minecraft:stripped_birch_log"}}] run function primitive:broken/stripped_log
execute as @s[nbt={Item:{id:"minecraft:stripped_jungle_log"}}] run function primitive:broken/stripped_log
execute as @s[nbt={Item:{id:"minecraft:stripped_acacia_log"}}] run function primitive:broken/stripped_log
execute as @s[nbt={Item:{id:"minecraft:stripped_dark_oak_log"}}] run function primitive:broken/stripped_log
execute as @s[nbt={Item:{id:"minecraft:stripped_mangrove_log"}}] run function primitive:broken/stripped_log
execute as @s[nbt={Item:{id:"minecraft:stripped_cherry_log"}}] run function primitive:broken/stripped_log
execute as @s[nbt={Item:{id:"minecraft:stripped_pale_oak_log"}}] run function primitive:broken/stripped_log
