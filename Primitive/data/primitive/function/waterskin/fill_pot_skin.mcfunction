...
execute if data entity @s SelectedItem.components.minecraft:custom_data.raw_water run scoreboard players set Temp reg_1 1
execute if data entity @s SelectedItem.components.minecraft:custom_data.salt_water run scoreboard players set Temp reg_2 1
