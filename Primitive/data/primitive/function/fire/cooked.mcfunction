...
data merge entity @s[nbt={Item:{id:"minecraft:stick",count:1}}] {Item:{id:torch,components:{custom_data:{hot:1,temperature:100},custom_name:{"text":"Burning stick","italic":false}}},NoGravity:1b}

data merge entity @s[nbt={Item:{id:"minecraft:raw_copper",count:1}}] {Item:{id:iron_nugget,components:{custom_data:{copper_nugget:1,hot:1,temperature:500},custom_name:{"text":"Copper nugget","italic":false}}},NoGravity:1b}
