...
data merge entity @s[nbt={Item:{id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:custom_data":{cured_brick:1}}}}] {Tags:["pot_broken"],Item:{id:bat_spawn_egg,components:{entity_data:{id:armor_stand,ShowArms:1b,Invisible:1b,Marker:1b,Invulnerable:1b,Silent:1b,Tags:[placed_fired_pot]},"minecraft:item_model":"minecraft:decorated_pot","minecraft:custom_name":["",{"text":"Fired pot","italic":false}],"minecraft:custom_data":{fired_pot:1}}},NoGravity:1b}
