...
execute store result score @s temperature run data get entity @s Item.components.minecraft:custom_data.temperature
scoreboard players remove @s temperature 1
execute store result entity @s Item.components.minecraft:custom_data.temperature int 1 run scoreboard players get @s temperature
